...
class Options:
    ...
    def _initial(self):
        ...
        self.parser.add_argument('--data_dir',       type=str, default='D:\\Human pose DB\\baseline_data\\data', help='path to dataset')
        ...
        self.parser.add_argument('--set_num_samples',         type=int, default=-1, help='Set the number of samples')
        ...
        self.parser.add_argument('--train_batch',    type=int,    default=8192) #8192
        self.parser.add_argument('--test_batch',     type=int,    default=8192)
